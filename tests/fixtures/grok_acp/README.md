...
name, and its recorded home directory and session scratch paths were
scrubbed too, each replaced everywhere by the same placeholder:
`operator-host` for the hostname, `operator` for the user name,
